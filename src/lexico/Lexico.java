...
public class Lexico {
	...
	/**
	 * verifica cada token que foi colocado pelo usu�rio
		...
		for (int i = 0; i < sequenciaLength; i++)
		{
			...
			case 1:
				...
				if (estadoAtual == 0)
				{
					if (ConstantesPalavrasReservadas.PALAVRAS_RESERVADAS.containsKey(sequenciaAtual.toString().toUpperCase()))
					{
						...
						returnList.add(new Token(0, sequenciaAtual.toString(), "Um Identificador n�o pode conter mais de 30 caracteres! Linha: " + this.linha));
					}

					i--;
					decrementaLinha(charAtual);
				} else if (estadoAtual < 0) {
					returnList.add(new Token(0, sequenciaAtual.toString(), "Caractere n�o reconhecido! Linha: " + this.linha));
					return returnList;
				}
			...
			case 7:
				...
				if (estadoAtual == 0)
				{
					...
					else if (sequenciaAtual.toString().equals("$"))
					{
						...
						System.err.println("[WARNING] Ignorou Token Inv�lido! Linha:" + this.linha);
			...
			case 14:
				...
				if (estadoAtual <= 0)
				{
					...
					{
						returnList.add(new Token(0, sequenciaAtual.toString(), "ILEGAL, n�o aceita ponto decimal nem outros caracteres! Linha: " + this.linha));
					}
			...
			if (estadoAtual >= 0)
			{
				...
				returnList.add(new Token(0, charAtual+"", "[WARNING] Ignorou Token Inv�lido! Linha: " + this.linha));
				estadoAtual = 0;
			}
