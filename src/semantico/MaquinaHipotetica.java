...
/**
 * �rea de instru��es da m�quina hipot�tica
 *
 */
class MaquinaHipotetica
{
	...
	//INICIALIZA A AREA DE INSTRU��ES(CODIGO DA INSTRU��O + OP1 + OP2)
	...
	//INCLUI UMA INSTRU��O NA AREA DE INSTRU��ES
	...
	//ALTERA UMA INSTRU��O NA AREA DE INSTRU��ES
	...
	public static boolean incluirAreaLiterais(Literais AL, String literal)
	{
		...
		if (AL.literais >= MaxList) {	//verifica se lista de literais chegou ao maximo
			aux = false;
		} else {	// se n�o adiciona literal a area e literais
			aux = true;
	...
	//indica endere�o do segmento de dados (base)
	...
	//analisa e executa o procedimento referente a cada uma das Instru��es
	public static void interpretar(Instrucoes AI, Literais AL)
	{
		...
		while (operador != 26)
		{
			...
			case 8:	//DIVI
				if (S[topo] == 0) {
					JOptionPane.showMessageDialog(null, "Divis�o por zero.", "Erro durante a execu��o", 0);
				} else {
					S[(topo - 1)] /= S[topo];
					topo -= 1;
				}
			...
			case 21:	//LEIT
				...
				break;
			case 22:	//IMPR
				JOptionPane.showMessageDialog(null, S[topo], "Informa��o",  1);
			...
			case 23:	//IMPRL
				if (a >= AL.literais)
					JOptionPane.showMessageDialog(null,
							"Literal n�o encontrado na �rea dos literais.",
