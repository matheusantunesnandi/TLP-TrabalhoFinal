...
//		Esvazia os erros sintáticos antes de instânciar a classe novamente, que fará um novo preenchimendo destes:
	...
	public void Erro(int j) {
		switch (j) {
		case 1:
			Sintatico.Erro_Sin.add("Defina um identificador - " + (i + 1) + "° token");
			break;
		case 2:
			Sintatico.Erro_Sin.add("Literal Não especificado - " + (i + 1) + "° token");
			break;
		case 3:
			Sintatico.Erro_Sin.add("Inteiro Não especificado - " + (i + 1) + "° token");
			break;
		case 4:
			Sintatico.Erro_Sin.add("Codigo incompleto - " + (i + 1) + "° token");
			break;
		case 5:
			Sintatico.Erro_Sin.add("Inicie o codigo com \"program\" - " + (i + 1) + "° token");
			break;
		case 6:
			Sintatico.Erro_Sin.add("Complete a instrução com \";\" (ponto e vírgula) - " + (i + 1) + "° token");
			break;
		case 7:
			Sintatico.Erro_Sin.add("Finalize o código com \".\" (ponto ) - " + (i + 1) + "° token");
			break;
		case 8:
			Sintatico.Erro_Sin.add("Expecifique um comando - " + (i + 1) + "° token");
			break;
		case 9:
			Sintatico.Erro_Sin.add("Complete a instrução com \":\" (dois pontos) - " + (i + 1) + "° token");
			break;
		case 10:
			Sintatico.Erro_Sin.add("Inicie o corpo com \"begin\" - " + (i + 2) + "° token");
			break;
		case 11:
			Sintatico.Erro_Sin.add("Finalize o corpo com \"end\" - " + (i + 1) + "° token");
			break;
		case 12:
			Sintatico.Erro_Sin.add("Defina a costante - " + (i + 1) + "° token");
			break;
		case 13:
			Sintatico.Erro_Sin.add("Defina uma procedure - " + (i + 1) + "° token");
			break;
		case 14:
			Sintatico.Erro_Sin.add("Defina um label - " + (i + 1) + "° token");
			break;
		case 15:
			Sintatico.Erro_Sin.add("Defina a(s) variável(is) - " + (i + 1) + "° token");
			break;
		case 16:
			Sintatico.Erro_Sin.add("Defina o inicio da espressão - " + (i + 1) + "° token");
			break;
		case 17:
			Sintatico.Erro_Sin
			...
			break;
		case 18:
			Sintatico.Erro_Sin.add("Defina a atribuição - " + (i + 1) + "° token");
			break;
		case 19:
			Sintatico.Erro_Sin.add("Defina os parametros - " + (i + 1) + "° token");
			break;
		case 20:
			Sintatico.Erro_Sin.add("Não escreva código depois do \"end.\"");
			break;
		case 21:
			Sintatico.Erro_Sin.add("Termine a primeira linha com \";\" (ponto e virgula) - " + (i + 1) + "° token");
			break;
		case 22:
			Sintatico.Erro_Sin.add("Comando \"for\" incompleto - " + (i + 1) + "° token");
			break;
		case 23:
			Sintatico.Erro_Sin.add("Comando \"call\" incompleto - " + (i + 1) + "° token");
			break;
		case 24:
			Sintatico.Erro_Sin.add("Comando \"goto\" incompleto - " + (i + 1) + "° token");
			break;
		case 25:
			Sintatico.Erro_Sin.add("Comando \"if\" incompleto - " + (i + 1) + "° token");
			break;
		case 26:
			Sintatico.Erro_Sin.add("Comando \"while\" incompleto - " + (i + 1) + "° token");
			break;
		case 27:
			Sintatico.Erro_Sin.add("Comando \"repeat\" incompleto - " + (i + 1) + "° token");
			break;
		case 28:
			Sintatico.Erro_Sin.add("Comando \"readln\" incompleto - " + (i + 1) + "° token");
			break;
		case 29:
			Sintatico.Erro_Sin.add("Comando \"writeln\" incompleto - " + (i + 1) + "° token");
			break;
		case 30:
			Sintatico.Erro_Sin.add("Comando \"case\" incompleto - " + (i + 1) + "° token");
			break;
		case 31:
			Sintatico.Erro_Sin.add("Separe comandos com \";\" (ponto e vigula) - " + (i + 1) + "° token");
			break;
		case 32:
			Sintatico.Erro_Sin.add("Termine o comando \"array\" - " + (i + 1) + "° token");
			break;
		case 33:
			Sintatico.Erro_Sin.add("Passagem de parametros incompleta ou errada - " + (i + 1) + "° token");
			break;
		default:
			Sintatico.Erro_Sin.add("Erro! - " + (i + 1) + "° token\n");
			break;
		}
	}
}