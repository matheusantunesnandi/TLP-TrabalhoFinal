...
public class Sintatico {
	...
	public Sintatico() {
		...
		A = (ArrayList<LexicoToken>) PrincipalGUI.ALfinal.clone();

		if (PROGRAMA()) {
			PrincipalGUI.Erro_Sin.removeAll(PrincipalGUI.Erro_Sin);
			PrincipalGUI.Erro_Sin.add("Codigo analizado com sucesso !");
		}
	}
	...
	public void Erro(int j) {
		switch (j) {
		case 1:
			PrincipalGUI.Erro_Sin.add("Defina um identificador - " + (i + 1) + "° token");
			break;
		case 2:
			PrincipalGUI.Erro_Sin.add("Literal Não especificado - " + (i + 1) + "° token");
			break;
		case 3:
			PrincipalGUI.Erro_Sin.add("Inteiro Não especificado - " + (i + 1) + "° token");
			break;
		case 4:
			PrincipalGUI.Erro_Sin.add("Codigo incompleto - " + (i + 1) + "° token");
			break;
		case 5:
			PrincipalGUI.Erro_Sin.add("Inicie o codigo com \"program\" - " + (i + 1) + "° token");
			break;
		case 6:
			PrincipalGUI.Erro_Sin.add("Complete a instrução com \";\" (ponto e vírgula) - " + (i + 1) + "° token");
			break;
		case 7:
			PrincipalGUI.Erro_Sin.add("Finalize o código com \".\" (ponto ) - " + (i + 1) + "° token");
			break;
		case 8:
			PrincipalGUI.Erro_Sin.add("Expecifique um comando - " + (i + 1) + "° token");
			break;
		case 9:
			PrincipalGUI.Erro_Sin.add("Complete a instrução com \":\" (dois pontos) - " + (i + 1) + "° token");
			break;
		case 10:
			PrincipalGUI.Erro_Sin.add("Inicie o corpo com \"begin\" - " + (i + 2) + "° token");
			break;
		case 11:
			PrincipalGUI.Erro_Sin.add("Finalize o corpo com \"end\" - " + (i + 1) + "° token");
			break;
		case 12:
			PrincipalGUI.Erro_Sin.add("Defina a costante - " + (i + 1) + "° token");
			break;
		case 13:
			PrincipalGUI.Erro_Sin.add("Defina uma procedure - " + (i + 1) + "° token");
			break;
		case 14:
			PrincipalGUI.Erro_Sin.add("Defina um label - " + (i + 1) + "° token");
			break;
		case 15:
			PrincipalGUI.Erro_Sin.add("Defina a(s) variável(is) - " + (i + 1) + "° token");
			break;
		case 16:
			PrincipalGUI.Erro_Sin.add("Defina o inicio da espressão - " + (i + 1) + "° token");
			break;
		case 17:
			PrincipalGUI.Erro_Sin
					.add("Você deve definir uma variável, um inteiro ou uma espressão - " + (i + 1) + "° token");
			break;
		case 18:
			PrincipalGUI.Erro_Sin.add("Defina a atribuição - " + (i + 1) + "° token");
			break;
		case 19:
			PrincipalGUI.Erro_Sin.add("Defina os parametros - " + (i + 1) + "° token");
			break;
		case 20:
			PrincipalGUI.Erro_Sin.add("Não escreva código depois do \"end.\"");
			break;
		case 21:
			PrincipalGUI.Erro_Sin.add("Termine a primeira linha com \";\" (ponto e virgula) - " + (i + 1) + "° token");
			break;
		case 22:
			PrincipalGUI.Erro_Sin.add("Comando \"for\" incompleto - " + (i + 1) + "° token");
			break;
		case 23:
			PrincipalGUI.Erro_Sin.add("Comando \"call\" incompleto - " + (i + 1) + "° token");
			break;
		case 24:
			PrincipalGUI.Erro_Sin.add("Comando \"goto\" incompleto - " + (i + 1) + "° token");
			break;
		case 25:
			PrincipalGUI.Erro_Sin.add("Comando \"if\" incompleto - " + (i + 1) + "° token");
			break;
		case 26:
			PrincipalGUI.Erro_Sin.add("Comando \"while\" incompleto - " + (i + 1) + "° token");
			break;
		case 27:
			PrincipalGUI.Erro_Sin.add("Comando \"repeat\" incompleto - " + (i + 1) + "° token");
			break;
		case 28:
			PrincipalGUI.Erro_Sin.add("Comando \"readln\" incompleto - " + (i + 1) + "° token");
			break;
		case 29:
			PrincipalGUI.Erro_Sin.add("Comando \"writeln\" incompleto - " + (i + 1) + "° token");
			break;
		case 30:
			PrincipalGUI.Erro_Sin.add("Comando \"case\" incompleto - " + (i + 1) + "° token");
			break;
		case 31:
			PrincipalGUI.Erro_Sin.add("Separe comandos com \";\" (ponto e vigula) - " + (i + 1) + "° token");
			break;
		case 32:
			PrincipalGUI.Erro_Sin.add("Termine o comando \"array\" - " + (i + 1) + "° token");
			break;
		case 33:
			PrincipalGUI.Erro_Sin.add("Passagem de parametros incompleta ou errada - " + (i + 1) + "° token");
			break;
		default:
			PrincipalGUI.Erro_Sin.add("Erro! - " + (i + 1) + "° token\n");
			break;
		}
	}
}